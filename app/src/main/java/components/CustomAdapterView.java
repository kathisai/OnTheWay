        ...
        Runnable r = new Runnable() {
			public void run() {
	            ...
	            if (selection >= 0) {
	                ...
	                mOnItemSelectedListener.onItemSelected(CustomAdapterView.this, v, selection, getAdapter().getItemId(selection));
	            } else {
	                mOnItemSelectedListener.onNothingSelected(CustomAdapterView.this);
	            }
			}
		};
